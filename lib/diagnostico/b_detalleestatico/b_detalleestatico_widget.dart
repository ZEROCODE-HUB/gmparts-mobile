...
import 'b_detalleestatico_model.dart';
export 'b_detalleestatico_model.dart';

class BDetalleestaticoWidget extends StatefulWidget {
  const BDetalleestaticoWidget({
    super.key,
    required this.datos,
  });
  ...
  static String routeName = 'b-Detalleestatico';
  static String routePath = '/bDetalleestatico';

  @override
  State<BDetalleestaticoWidget> createState() => _BDetalleestaticoWidgetState();
}
...
class _BDetalleestaticoWidgetState extends State<BDetalleestaticoWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BDetalleestaticoModel());
  ...
  child: Container(
                        ...
                        if (widget.datos != null &&
                            widget.datos!.fotosFinalizacion.isNotEmpty)
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                0.0, 25.0, 0.0, 0.0),
                            child: Container(
