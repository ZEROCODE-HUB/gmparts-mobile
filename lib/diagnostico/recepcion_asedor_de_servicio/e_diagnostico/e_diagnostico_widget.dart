...
import 'e_diagnostico_model.dart';
export 'e_diagnostico_model.dart';

class EDiagnosticoWidget extends StatefulWidget {
  const EDiagnosticoWidget({
    super.key,
    this.numeroorden,
  });
  ...
  static String routeName = 'e-diagnostico';
  static String routePath = '/eDiagnostico';

  @override
  State<EDiagnosticoWidget> createState() => _EDiagnosticoWidgetState();
}
...
class _EDiagnosticoWidgetState extends State<EDiagnosticoWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EDiagnosticoModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<RecepcionesRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<RecepcionesRecord> eDiagnosticoRecepcionesRecordList =
            snapshot.data!;
        final eDiagnosticoRecepcionesRecord =
            eDiagnosticoRecepcionesRecordList.isNotEmpty
                ? eDiagnosticoRecepcionesRecordList.first
                : null;
