...
import 'addarticles_model.dart';
export 'addarticles_model.dart';

class AddarticlesWidget extends StatefulWidget {
  const AddarticlesWidget({
    super.key,
    this.tipoPersona,
  ...
  final Future Function(int refresh)? accion;

  @override
  State<AddarticlesWidget> createState() => _AddarticlesWidgetState();
}
...
class _AddarticlesWidgetState extends State<AddarticlesWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddarticlesModel());

    _model.codigoTextController ??= TextEditingController();
    _model.codigoFocusNode ??= FocusNode();

    _model.oemTextController ??= TextEditingController();
    _model.oemFocusNode ??= FocusNode();

    _model.codigoproveedorTextController ??= TextEditingController();
    _model.codigoproveedorFocusNode ??= FocusNode();

    _model.nombreTextController ??= TextEditingController();
    _model.nombreFocusNode ??= FocusNode();

    _model.stockeminimoTextController ??= TextEditingController();
    _model.stockeminimoFocusNode ??= FocusNode();

    _model.preciocompraTextController ??= TextEditingController();
    _model.preciocompraFocusNode ??= FocusNode();

    _model.utilidadTextController ??= TextEditingController();
    _model.utilidadFocusNode ??= FocusNode();

    _model.codigodebarrasTextController ??= TextEditingController();
    ...
    _model.pvtamayorTextController ??= TextEditingController();
                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: [
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        width: 300.0,
                                        child: TextFormField(
                                          controller: _model.oemTextController,
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: TextFormField(
                                            ...
                                            focusNode:
                                                _model.codigoproveedorFocusNode,
                                            autofocus: false,
                                            autofillHints: [
                                              AutofillHints.telephoneNumber
                                            ],
                                      ...
                                      children: [
                                        ...
                                        StreamBuilder<
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            List<ArticleBrandMarcaRecord>
                                                ddGrupoArticleBrandMarcaRecordList =
                                                snapshot.data!;

                                            return FlutterFlowDropDown<String>(
                                              controller: _model
                                                      .ddGrupoValueController1 ??=
                                                  FormFieldController<String>(
                                                      null),
                                              options:
                                                  ddGrupoArticleBrandMarcaRecordList
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      StreamBuilder<
                                        ...
                                        stream: queryMeasurementUnitRecord(
                                          queryBuilder:
                                      ...
                                      children: [
                                        ...
                                        StreamBuilder<List<GroupRecord>>(
                                          ...
                                          builder: (context, snapshot) {
                                            ...
                                            return FlutterFlowDropDown<String>(
                                              controller: _model
                                                      .ddGrupoValueController2 ??=
                                                  FormFieldController<String>(
                                                      null),
                                              options: ddGrupoGroupRecordList
                                                  .map((e) => e.name)
                                                  .toList(),
                                              onChanged: (val) => safeSetState(
                                                  () => _model.ddGrupoValue2 =
                                                      val),
                                              width: 300.0,
                                              height: 50.0,
                                              searchHintTextStyle:
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          return FlutterFlowDropDown<String>(
                                            controller: _model
                                                ...
                                                FormFieldController<String>(
                                                    null),
                                            options: ddSubgruSubgroupRecordList
                                                .map((e) => e.name)
                                                .toList(),
                                            onChanged: (val) => safeSetState(
                                                () =>
                                                    _model.ddSubgruValue = val),
                                            width: 300.0,
                                            height: 50.0,
                                            searchHintTextStyle:
                                                _theme
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: TextFormField(
                                            ...
                                            focusNode: _model.utilidadFocusNode,
                                            autofocus: false,
                                            autofillHints: [
                                              AutofillHints.telephoneNumber
                                            ],
                                      ...
                                      children: [
                                        ...
                                        Container(
                                          ...
                                          child: TextFormField(
                                            ...
                                            focusNode:
                                                _model.codigodebarrasFocusNode,
                                            autofocus: false,
                                            autofillHints: [
                                              AutofillHints.telephoneNumber
                                            ],
                                            ...
                                            if (selectedMedia != null &&
                                                selectedMedia.every((m) =>
                                                    validateFileFormat(
                                                        ...
                                                        context))) {
                                              safeSetState(() => _model
                                                      .isDataUploading_uploadDataJ4w11 =
                                                  true);
                                              ...
                                              try {
                                                ...
                                                _model.isDataUploading_uploadDataJ4w11 =
                                                    false;
                                              }
                                              if (selectedUploadedFiles
                                                  ...
                                                  downloadUrls.length ==
                                                      selectedMedia.length) {
                                                safeSetState(() {
                                                  _model.uploadedLocalFile_uploadDataJ4w11 =
                                                      selectedUploadedFiles
                                                          .first;
                                                  _model.uploadedFileUrl_uploadDataJ4w11 =
                                                      downloadUrls.first;
                                                });
                                              } else {
                                                safeSetState(() {});
                            ...
                            if (_model.uploadedFileUrl_uploadDataJ4w11 != '')
                              ClipRRect(
                              ...
                              child: Row(
                                ...
                                children: [
                                  FFButtonWidget(
                                    onPressed: () async {
                                      safeSetState(() {
                                        _model.codigoTextController?.clear();
                                        _model.oemTextController?.clear();
                                        _model.codigoproveedorTextController
                                            ?.clear();
                                        _model.nombreTextController?.clear();
                                        _model.stockeminimoTextController
                                            ?.clear();
                                        _model.preciocompraTextController
                                            ?.clear();
                                        _model.utilidadTextController?.clear();
                                        _model.codigodebarrasTextController
                                            ?.clear();
                                        ...
                                        _model.pvtamayorTextController?.clear();
                                      });
                                      safeSetState(() {
                                        _model.ddProductotValueController
                                            ?.reset();
                                        _model.ddProductotValue = null;
                                        _model.marcaValueController?.reset();
                                        _model.marcaValue = null;
                                        _model.ddUnidaddemedidaValueController
                                            ?.reset();
                                        _model.ddUnidaddemedidaValue = null;
                                        _model.ddGrupoValueController2?.reset();
                                        _model.ddGrupoValue2 = null;
                                        _model.ddSubgruValueController?.reset();
                                        _model.ddSubgruValue = null;
                                        _model.garantaValueController?.reset();
                                        _model.garantaValue = null;
                                        _model.noserieValueController?.reset();
                                        _model.noserieValue = null;
                                        _model.monedaValueController?.reset();
                                      ...
                                      onPressed: () async {
                                        await ArticlesRecord.collection
                                            ...
                                            .set(createArticlesRecordData(
                                              ...
                                              marcaBrand: _model.marcaValue,
                                              unidadDeMedidaMeasurementUnit:
                                                  _model.ddUnidaddemedidaValue,
                                              groupGrupo: _model.ddGrupoValue2,
                                              subgroupSubgrupo:
                                              ...
                                              imagenPicture: _model
                                                  .uploadedFileUrl_uploadDataJ4w11,
