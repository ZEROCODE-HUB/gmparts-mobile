                      ...
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            if (widget.recepcion?.comentariosFinalizacion != null &&
                                widget.recepcion!.comentariosFinalizacion.isNotEmpty)
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 25.0, 0.0, 0.0),
                                child: Container(
                            ...
                            if (widget.recepcion?.fotosFinalizacion != null &&
                                widget.recepcion!.fotosFinalizacion.isNotEmpty)
                              Padding(
                                padding: EdgeInsetsDirectional.fromSTEB(
                                    0.0, 25.0, 0.0, 0.0),
                                child: Container(
