...
import 'd_fincliente_model.dart';
export 'd_fincliente_model.dart';

class DFinclienteWidget extends StatefulWidget {
  const DFinclienteWidget({super.key});

  static String routeName = 'd-fincliente';
  static String routePath = '/dFincliente';

  @override
  State<DFinclienteWidget> createState() => _DFinclienteWidgetState();
}
...
class _DFinclienteWidgetState extends State<DFinclienteWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DFinclienteModel());
