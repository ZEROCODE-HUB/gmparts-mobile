...
import 'b_dash_board_diagnostico_model.dart';
export 'b_dash_board_diagnostico_model.dart';

class BDashBoardDiagnosticoWidget extends StatefulWidget {
  const BDashBoardDiagnosticoWidget({
    super.key,
    required this.datos,
  });

  final RecepcionesRecord? datos;

  static String routeName = 'b-DashBoardDiagnostico';
  static String routePath = '/bDashBoardDiagnostico';

  @override
  State<BDashBoardDiagnosticoWidget> createState() =>
      _BDashBoardDiagnosticoWidgetState();
}
...
class _BDashBoardDiagnosticoWidgetState
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BDashBoardDiagnosticoModel());
                                  ...
                                  InkWell(
                                    ...
                                    onTap: () async {
                                      context.pushNamed(
                                        ...
                                        queryParameters: {
                                          'recepcionid': serializeParam(
                                            widget.datos?.reference,
