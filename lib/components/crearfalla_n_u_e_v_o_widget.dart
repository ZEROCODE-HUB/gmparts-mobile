...
import '/components/gestion_servicio_nuevo_crear_widget.dart';
...
import 'crearfalla_n_u_e_v_o_model.dart';
export 'crearfalla_n_u_e_v_o_model.dart';

class CrearfallaNUEVOWidget extends StatefulWidget {
  const CrearfallaNUEVOWidget({
    super.key,
    this.recepcionRef,
  });
  ...
  @override
  State<CrearfallaNUEVOWidget> createState() => _CrearfallaNUEVOWidgetState();
}
...
class _CrearfallaNUEVOWidgetState extends State<CrearfallaNUEVOWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CrearfallaNUEVOModel());
                                                  ...
                                                  AlignmentDirectional(0.0, 0.0)
                                                      .resolve(
                                                          Directionality.of(
                                                              context)),
                                              child:
                                                  GestionServicioNuevoCrearWidget(),
                                            );
                                          },
                                        );
                                      },
                              ...
                              StreamBuilder<List<ServiceRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return FlutterFlowDropDown<String>(
                                    ...
                                    options: ddTipodeServicioServiceRecordList
                                        .map((e) => e.descripcion)
                                        .toList(),
                                        ...
                                        builder: (dialogContext) {
                                          return Dialog(
                                            ...
                                            child: ElegirInsumosCopyWidget(
                                              tipo: FFAppConstants.tipoRepuesto,
                                              actionguardarins:
                                                  (repuesto) async {
                                                _model.addToRepuestos(repuesto);
                                                safeSetState(() {});
                                                Navigator.pop(context);
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              ...
                              if (selectedMedia != null &&
                                ...
                                safeSetState(() => _model
                                    .isDataUploading_uploadDataMaw = true);
                                ...
                                try {
                                  ...
                                  ScaffoldMessenger.of(context)
                                      .hideCurrentSnackBar();
                                  _model.isDataUploading_uploadDataMaw = false;
                                }
                                if (selectedUploadedFiles.length ==
                                    selectedMedia.length) {
                                  safeSetState(() {
                                    _model.uploadedLocalFile_uploadDataMaw =
                              ...
                              if (((_model.uploadedLocalFile_uploadDataMaw
                                              .bytes?.isNotEmpty ??
                                          false)) &&
                                  (_model.fotos.contains(_model
                                          .uploadedLocalFile_uploadDataMaw) ==
                                      false)) {
                                _model.addToFotos(
                                    _model.uploadedLocalFile_uploadDataMaw);
                                _model.updatePage(() {});
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      final fotoss = _model.fotos.toList();

                                      return SingleChildScrollView(
                                        scrollDirection: Axis.horizontal,
                                        child: Row(
                                          mainAxisSize: MainAxisSize.min,
                                          children: List.generate(fotoss.length,
                                                  (fotossIndex) {
                                            final fotossItem =
                                                fotoss[fotossIndex];
                                            return Align(
