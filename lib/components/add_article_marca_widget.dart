...
import 'add_article_marca_model.dart';
export 'add_article_marca_model.dart';

class AddArticleMarcaWidget extends StatefulWidget {
  const AddArticleMarcaWidget({super.key});

  @override
  State<AddArticleMarcaWidget> createState() => _AddArticleMarcaWidgetState();
}
...
class _AddArticleMarcaWidgetState extends State<AddArticleMarcaWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddArticleMarcaModel());
                    ...
                    Builder(
                      builder: (context) => Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await ArticleBrandMarcaRecord.collection
                                .doc()
                                .set(createArticleBrandMarcaRecordData(
