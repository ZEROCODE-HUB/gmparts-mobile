...
import 'gestion_servicio_nuevo_editar_model.dart';
export 'gestion_servicio_nuevo_editar_model.dart';

class GestionServicioNuevoEditarWidget extends StatefulWidget {
  const GestionServicioNuevoEditarWidget({
    super.key,
  ...
  @override
  State<GestionServicioNuevoEditarWidget> createState() =>
      _GestionServicioNuevoEditarWidgetState();
}
...
class _GestionServicioNuevoEditarWidgetState
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GestionServicioNuevoEditarModel());
  ...
  Widget build(BuildContext context) {
    ...
    return Align(
      ...
      child: StreamBuilder<ServiceRecord>(
        stream: ServiceRecord.getDocument(widget.servicio!),
        builder: (context, snapshot) {
          ...
          final containerServiceRecord = snapshot.data!;
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.codigoservTextController ??=
                                                TextEditingController(
                                          text: containerServiceRecord.codigo,
                                        ),
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: TextFormField(
                                        controller:
                                            _model.precioservTextController ??=
                                                TextEditingController(
                                          text: containerServiceRecord.precio
                                              .toString(),
                                        ),
                                    ...
                                    child: FlutterFlowDropDown<String>(
                                      controller:
                                        ...
                                        _model.alertadiasValue ??=
                                            containerServiceRecord.alertInDays,
                                      ),
                                      options: [
                                        '0 días',
                                        '1 día',
                                    ...
                                    child: FlutterFlowDropDown<String>(
                                      controller:
                                          _model.monedaValueController ??=
                                              FormFieldController<String>(
                                        _model.monedaValue ??=
                                            containerServiceRecord.currency,
                                      ),
                                      ...
                                      FlutterFlowDropDown<String>(
                                        controller:
                                            _model.ddSistemaValueController ??=
                                                FormFieldController<String>(
                                          _model.ddSistemaValue ??=
                                              containerServiceRecord.sistema,
                                        ),
                                        options: [
                                          'Motor',
                                          'Frenos',
                                        ...
                                        child: TextFormField(
                                          controller:
                                              _model.notasservTextController ??=
                                                  TextEditingController(
                                            text: containerServiceRecord.note,
                                          ),
                                        ...
                                        child: FFButtonWidget(
                                          onPressed: () async {
                                            await widget.servicio!
                                                .update(createServiceRecordData(
                                              codigo: _model
