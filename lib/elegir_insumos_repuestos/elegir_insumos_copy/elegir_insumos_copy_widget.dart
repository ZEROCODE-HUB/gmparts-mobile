...
import 'elegir_insumos_copy_model.dart';
export 'elegir_insumos_copy_model.dart';

class ElegirInsumosCopyWidget extends StatefulWidget {
  const ElegirInsumosCopyWidget({
    super.key,
    this.actionguardarins,
    required this.tipo,
  });

  final Future Function(RepuestosStruct repuesto)? actionguardarins;
  final String? tipo;

  @override
  State<ElegirInsumosCopyWidget> createState() =>
      _ElegirInsumosCopyWidgetState();
}
...
class _ElegirInsumosCopyWidgetState extends State<ElegirInsumosCopyWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ElegirInsumosCopyModel());
